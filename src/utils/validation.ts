import { isOk, validationPromise } from "../database/controllers/utils";
import { EmailsModel } from "../database/models/emails";
import { quiggleErr } from "./errors";
...
export function validateEmail(props: any, error = quiggleErr('email')): Promise<unknown[]> {
  ...
  const promises = [
    ...
    validationPromise(EMAIL !== '' && EMAIL !== undefined, error, 'required', props!.res),
  ]
